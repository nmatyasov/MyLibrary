        ...
        public static void Run()
        {
            ...
            using (var transaction = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    BookPublisher _bp1 = new BookPublisher(); _bp1.BookId = 1; _bp1.PublisherId = 3; db.BookPublishers.Add(_bp1);
                    BookPublisher _bp2 = new BookPublisher(); _bp2.BookId = 2; _bp2.PublisherId = 1; db.BookPublishers.Add(_bp2);
                    BookPublisher _bp3 = new BookPublisher(); _bp3.BookId = 3; _bp3.PublisherId = 4; db.BookPublishers.Add(_bp3);
                    BookPublisher _bp4 = new BookPublisher(); _bp4.BookId = 4; _bp4.PublisherId = 2; db.BookPublishers.Add(_bp4);
                    BookPublisher _bp5 = new BookPublisher(); _bp5.BookId = 5; _bp5.PublisherId = 5; db.BookPublishers.Add(_bp5);
                    ...
                    Publisher _p1 = new Publisher()
                    {
                        PublisherId = 1,
                        Name = "CRC Press",
                        BookPublisher = new List<BookPublisher>()
                         {
                            _bp2
                         }
                    };
